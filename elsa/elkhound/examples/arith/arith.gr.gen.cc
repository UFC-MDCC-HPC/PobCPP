...
sm::string Arith::terminalDescription(int termId, SemanticValue sval)
{
...
sm::string Arith::nonterminalDescription(int nontermId, SemanticValue sval)
{
...
inline int Arith::action0___EarlyStartSymbol(SourceLoc loc, SourceLoc endloc, int top)
#line 1 "<init>"
{ return top;  }
#line 63 "arith.gr.gen.cc"

// [1] Exp[int] -> e1:Exp + e2:Exp %prec(10)
inline int Arith::action1_Exp(SourceLoc loc, SourceLoc endloc, int e1, int e2)
#line 106 "arith.gr"
{ return e1 + e2;  }
#line 69 "arith.gr.gen.cc"

// [2] Exp[int] -> e1:Exp - e2:Exp %prec(10)
inline int Arith::action2_Exp(SourceLoc loc, SourceLoc endloc, int e1, int e2)
#line 108 "arith.gr"
{ return e1 - e2;  }
#line 75 "arith.gr.gen.cc"

// [3] Exp[int] -> e1:Exp * e2:Exp %prec(20)
inline int Arith::action3_Exp(SourceLoc loc, SourceLoc endloc, int e1, int e2)
#line 109 "arith.gr"
{ return e1 * e2;  }
#line 81 "arith.gr.gen.cc"

// [4] Exp[int] -> e1:Exp / e2:Exp %prec(20)
inline int Arith::action4_Exp(SourceLoc loc, SourceLoc endloc, int e1, int e2)
#line 110 "arith.gr"
{ return e1 / e2;  }
#line 87 "arith.gr.gen.cc"

// [5] Exp[int] -> n:TOK_NUMBER
inline int Arith::action5_Exp(SourceLoc loc, SourceLoc endloc, int n)
#line 111 "arith.gr"
{ return n;  }
#line 93 "arith.gr.gen.cc"

// [6] Exp[int] -> p:ParenthesizedExp
inline int Arith::action6_Exp(SourceLoc loc, SourceLoc endloc, int p)
#line 112 "arith.gr"
{ return p;  }
#line 99 "arith.gr.gen.cc"

// [7] ParenthesizedExp[int] -> ( e:Exp )
inline int Arith::action7_ParenthesizedExp(SourceLoc loc, SourceLoc endloc, int e)
#line 118 "arith.gr"
{ return e;  }
#line 105 "arith.gr.gen.cc"
  ...
  SourceLoc endloc)
{
  switch (productionId) {
    case 0:
      return (SemanticValue)(ths->action0___EarlyStartSymbol(loc, endloc, (int)(semanticValues[0])));
    case 1:
      return (SemanticValue)(ths->action1_Exp(loc, endloc, (int)(semanticValues[0]), (int)(semanticValues[2])));
    case 2:
      return (SemanticValue)(ths->action2_Exp(loc, endloc, (int)(semanticValues[0]), (int)(semanticValues[2])));
    case 3:
      return (SemanticValue)(ths->action3_Exp(loc, endloc, (int)(semanticValues[0]), (int)(semanticValues[2])));
    case 4:
      return (SemanticValue)(ths->action4_Exp(loc, endloc, (int)(semanticValues[0]), (int)(semanticValues[2])));
    case 5:
      return (SemanticValue)(ths->action5_Exp(loc, endloc, (int)(semanticValues[0])));
    case 6:
      return (SemanticValue)(ths->action6_Exp(loc, endloc, (int)(semanticValues[0])));
    case 7:
      return (SemanticValue)(ths->action7_ParenthesizedExp(loc, endloc, (int)(semanticValues[1])));
    default:
