...
inline char const *toXml(AnEnum id)
  { return toString(id); }
...
inline char const *toXml(AnotherEnum id)
  { return toString(id); }
...
public:      // funcs
  explicit ExampleDVisitor(ExampleVisitor *client0 = NULL, bool ensureOneVisit0 = false)
    : client(client0)
...
class ToXmlASTVisitor : public ExampleVisitor {
protected:   // data
...
public:      // funcs
  explicit ToXmlASTVisitor(std::ostream &out0, int &depth0, bool indent0 = false)
    : out(out0)
    , depth(depth0)
    , indent(indent0)
  {}
